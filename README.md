...
skills/
  ...
  unfrak-lock/SKILL.md        # test the ratified behavior; then find the undocumented rules
  unfrak-describe/SKILL.md    # write the architecture notes once the structure settles
  ...
  unfrak-design/SKILL.md      # recover or establish a design standard (whole product, not per-area)
